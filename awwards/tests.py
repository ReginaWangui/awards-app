...
class ProfileTest(TestCase):
    def setUp(self):
        ...
        run before test
        '''
        user1=User(username='Reginah')
        user1.save()
        self.profile1=Profile(user=user1,bio='Software developer',email='reginahwangu801@gmail.com')
...
class ProjectTest(TestCase):
    def setUp(self):
        ...
        user1=User(username='Reginah')
        user1.save()
        profile1=Profile(user=user1,bio='Software developer',email='reginahwangui801@gmail.com')
        profile1.save()
